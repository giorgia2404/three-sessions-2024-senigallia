...
export function sketch() {
    ...
    mirrorMate2 = new THREE.MeshPhongMaterial({
        color: 0x444444,
    ...
    mirrorBack2.position.z = 7;
    mirrorBack2.position.x = 10;
    mirrorBack2.rotation.y = Math.PI/3;
    scene.add(mirrorBack2);
    // let's make the mirror backside to do a shadow
    reflectorBackGeom2 = new THREE.PlaneGeometry(mirrorW, mirrorH)
    let reflectorBack2 = new THREE.Mesh(reflectorBackGeom2, mirrorMate2)
    reflectorBack2.position.y = mirrorBack2.position.y
    reflectorBack2.position.z = mirrorBack2.position.z + 0.02
    ...
    mirrorBack3.position.z = 7;
    mirrorBack3.position.x = -10;
    mirrorBack3.rotation.y = -Math.PI/3;
    scene.add(mirrorBack3);
    // let's make the mirror backside to do a shadow
    reflectorBackGeom3 = new THREE.PlaneGeometry(mirrorW, mirrorH)
    let reflectorBack3 = new THREE.Mesh(reflectorBackGeom3, mirrorMate2)
    reflectorBack3.position.y = mirrorBack3.position.y
    reflectorBack3.position.z = mirrorBack3.position.z + 0.02
